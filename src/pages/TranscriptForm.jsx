...
const requiredFields = ["transcript", "transcriptShortName", "priority"];
...
function TranscriptForm() {
    ...
    axios
      ...
      .then((res) => {
        setValues({
          ...
          transcriptShortName: res.data.data.transcript_short_name,
  ...
  const handleCreate = async () => {
    if (Object.values(formValid).includes(false)) {
      ...
      temp.transcript_short_name = values.transcriptShortName;
      ...
      <FormWrapper>
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            <CustomTextField
              name="transcriptShortName"
              label="Short Name"
              value={values.transcriptShortName}
              handleChange={handleChange}
              errors={["This field is required"]}
              checks={[values.transcriptShortName !== ""]}
              setFormValid={setFormValid}
              required
              fullWidth
            />
          ...
          <Grid item xs={12} md={6}>
            <CustomTextField
              ...
              checks={[values.priority !== "", /[0-9]/.test(values.priority)]}
              setFormValid={setFormValid}
              required
            />
          </Grid>
