...
function EmployeeIndex() {
  ...
  return (
    <Box sx={{ position: "relative", mt: 2 }}>
      ...
      {!!state.isOpenJobTypeModal && <ModalWrapper
        title="Job Type Change"
        maxWidth={400}
        open={state.isOpenJobTypeModal}
        setOpen={() => handleJobTypeModal()}
      >
        <JobTypeChange jobTypeId={state.jobTypeId} jobTypeLists={state.jobTypeLists} empId={state.empId} handleJobTypeModal={handleJobTypeModal}/>
      </ModalWrapper>}
